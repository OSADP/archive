[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(IDTO.WebAPI.App_Start.NinjectWebCommon), "Start")]
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(IDTO.WebAPI.App_Start.NinjectWebCommon), "Stop")]

namespace IDTO.WebAPI.App_Start
{
    using System;
    using System.Web;
    ...
    public static class NinjectWebCommon 
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            string connectionString = ConfigurationManager.ConnectionStrings["IDTOContext"].ConnectionString;
