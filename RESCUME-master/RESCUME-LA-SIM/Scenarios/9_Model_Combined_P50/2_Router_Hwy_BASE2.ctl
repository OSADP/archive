...
UPDATE_PLAN_RECORDS                     TRUE

PERFORMANCE_FILE						Results\Router_Hwy_LinkPerformance_BASE
TURN_DELAY_FILE							Results\Router_Hwy_TurnDelay_BASE
PLAN_FILE								Demand\Plans_BASE

NEW_PLAN_FILE                           Demand\Plans_BASE2						//---- [project_directory]filename.*
...
NEW_PROBLEM_FILE                        Results\Router_Hwy_Problems_BASE2.csv						//---- [project_directory]filename.*
...
##NEW_PERFORMANCE_FILE                    Results\Router_Hwy_LinkPerformance_BASE2
...
##NEW_TURN_DELAY_FILE                     Results\Router_Hwy_TurnDelay_BASE2
...
MAXIMUM_NUMBER_OF_ITERATIONS            1                       //---- 0..1000
...
APPLICATION_METHOD                      TRAVEL_PLANS // DUE_PLANS            	 //---- TRAVEL_PLANS, LINK_FLOWS, DUE_PLANS, DTA_FLOWS
...
##NEW_CAPACITY_CONSTRAINT_FILE			Outputs\Capacity_Constraints_BASE2.txt
...
NEW_FUEL_CONSTRAINT_FILE                Outputs\Fuel_Constraints_BASE2.txt
CONSTRAINT_TIME_INCREMENT               0
