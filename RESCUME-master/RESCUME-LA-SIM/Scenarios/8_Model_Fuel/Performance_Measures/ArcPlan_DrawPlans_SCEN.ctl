...
LOCATION_FILE                           ..\..\..\Common_Inputs\6_Network_Merged\ASCIIFiles\Location_Fuel.csv                        //---- [project_directory]filename
...
PARKING_FILE                            ..\..\..\Common_Inputs\6_Network_Merged\ASCIIFiles\Parking.csv                        //---- [project_directory]filename
...
SHAPE_FILE                              ..\..\..\Common_Inputs\6_Network_Merged\ASCIIFiles\Shape.csv                        //---- [project_directory]filename
...
ACCESS_FILE                             ..\..\..\Common_Inputs\6_Network_Merged\ASCIIFiles\Access.csv                        //---- [project_directory]filename
...
TRANSIT_STOP_FORMAT                     TAB_DELIMITED           //---- TEXT, BINARY, FIXED_COLUMN, COMMA_DELIMITED, SPACE_DELIMITED, TAB_DELIMITED, CSV_DELIMITED, DBASE, ARCVIEW, SQLITE3, VERSION3, TPPLUS, CUBE, TRANSCAD
TRANSIT_ROUTE_FILE                                              //---- [project_directory]filename
TRANSIT_ROUTE_FORMAT                    TAB_DELIMITED           //---- TEXT, BINARY, FIXED_COLUMN, COMMA_DELIMITED, SPACE_DELIMITED, TAB_DELIMITED, CSV_DELIMITED, DBASE, ARCVIEW, SQLITE3, VERSION3, TPPLUS, CUBE, TRANSCAD
TRANSIT_DRIVER_FILE                                             //---- [project_directory]filename
TRANSIT_DRIVER_FORMAT                   TAB_DELIMITED           //---- TEXT, BINARY, FIXED_COLUMN, COMMA_DELIMITED, SPACE_DELIMITED, TAB_DELIMITED, CSV_DELIMITED, DBASE, ARCVIEW, SQLITE3, VERSION3, TPPLUS, CUBE, TRANSCAD
...
## PLAN_FILE                               ..\Demand\Save_Plans_SCEN-dbr.txt                        //---- [project_directory]filename.*
##PLAN_FILE                               Performance_Measures_Shapefiles\Plans_PathSkim_SCEN.txt                       //---- [project_directory]filename.*
## PLAN_FILE                               ..\Outputs\Plans_SCEN_Select                       //---- [project_directory]filename.*
...
SELECT_HOUSEHOLDS                       79253 // 68925 // 362168 // 361150 //  // 386913 (EVAC Bad) // 81454 // 336556 (EVAC Bad) // 309870 (Non-EVAC Bad) // 298070 (GOOD) // 361325                    //---- e.g., 1, 2, 4..10, 100..200, 300
...
NEW_ARC_PLAN_FILE                       Performance_Measures_Shapefiles\Plans_Select_SCEN.shp                        //---- [project_directory]filename
## NEW_ARC_PLAN_FILE                       Performance_Measures_Shapefiles\Plans_SavePlan_SCEN.shp                        //---- [project_directory]filename
##NEW_ARC_PLAN_FILE                       Performance_Measures_Shapefiles\Plans_PathSkim_SCEN.shp                        //---- [project_directory]filename
