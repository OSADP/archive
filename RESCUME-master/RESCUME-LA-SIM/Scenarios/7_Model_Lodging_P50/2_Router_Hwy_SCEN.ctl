...
LOCATION_FILE                           ..\..\Common_Inputs\6_Network_Merged\ASCIIFiles\Location_Cap_Share.csv
...
PERFORMANCE_FILE                        Results\Router_Hwy_LinkPerformance_BASE                        //---- [project_directory]filename
...
TURN_DELAY_FILE                         Results\Router_Hwy_TurnDelay_BASE                        //---- [project_directory]filename
...
## TRIP_FILE                               Demand\Trips_Hwy_ExitUpdated.csv    //---- [project_directory]filename.*
...
PLAN_FILE                               Demand\Plans_BASE                        //---- [project_directory]filename.*
...
SELECT_PRIORITIES                       HIGH, CRITICAL                     //---- ALL, or 0..4, or LOW, MEDIUM, HIGH, CRITICAL
...
SELECT_TRAVELER_TYPES                   4                     //---- e.g., 1, 2, 4..10, 100..200, 300
...
## VDOT
EQUATION_PARAMETERS_1                             CONICAL,   4, 50             //  1 => FREEWAY                 Conical VDF A=Alpha, B=MaxTTI
EQUATION_PARAMETERS_2                             CONICAL,    4, 50             //  2 => EXPRESSWAY              Conical VDF A=Alpha, B=MaxTTI
EQUATION_PARAMETERS_4                             CONICAL,    4, 50             //  4 => MAJOR                   Conical VDF A=Alpha, B=MaxTTI
...
MAXIMUM_NUMBER_OF_ITERATIONS            10 // 10                       //---- 0..1000
...
SAVE_AFTER_ITERATIONS                   0                    //---- TRUE/FALSE, YES/NO, 1/0, T/F, Y/N
NEW_SAVE_PLAN_FILE						
NEW_SAVE_PLAN_FORMAT					TAB_DELIMITED
SAVE_PLAN_HOUSEHOLDS					128
...
APPLICATION_METHOD                      DUE_PLANS  // DUE_PLANS            	 //---- TRAVEL_PLANS, LINK_FLOWS, DUE_PLANS, DTA_FLOWS
