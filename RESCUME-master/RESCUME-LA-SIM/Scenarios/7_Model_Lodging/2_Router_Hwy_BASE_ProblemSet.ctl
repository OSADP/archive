...
RANDOM_NUMBER_SEED                      1111                       //---- 0 = computer clock, > 0 = fixed
...
SELECTION_FILE                          Results\Router_Hwy_Problems_BASE.csv    					//---- [project_directory]filename.*
SELECTION_FORMAT                        COMMA_DELIMITED           //---- TEXT, BINARY, FIXED_COLUMN, COMMA_DELIMITED, SPACE_DELIMITED, TAB_DELIMITED, CSV_DELIMITED, DBASE, ARCVIEW, SQLITE3, VERSION3, TPPLUS, CUBE
...
NEW_PLAN_FILE                           Demand\Plans_BASE_ProblemSet						//---- [project_directory]filename.*
...
NEW_PROBLEM_FILE                        Results\Router_Hwy_Problems_BASE_ProblemSet.csv						//---- [project_directory]filename.*
...
NEW_PERFORMANCE_FILE                    Results\Router_Hwy_LinkPerformance_BASE_ProblemSet
...
NEW_TURN_DELAY_FILE                     Results\Router_Hwy_TurnDelay_BASE_ProblemSet
...
## NEW_SAVE_PLAN_FILE						Demand\Save_Plans_BASE_ProblemSet.txt
NEW_SAVE_PLAN_FORMAT					TAB_DELIMITED
SAVE_PLAN_HOUSEHOLDS					17620,38165
...
INITIALIZE_TRIP_PRIORITY                NO                		 //---- NO, LOW, MEDIUM, HIGH, CRITICAL
...
NEW_CAPACITY_CONSTRAINT_FILE			Outputs\Capacity_Constraints_BASE_ProblemSet.txt
