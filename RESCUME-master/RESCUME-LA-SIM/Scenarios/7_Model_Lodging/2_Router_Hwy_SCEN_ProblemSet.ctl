...
SELECTION_FILE                          Results\Router_Hwy_Problems_SCEN.csv    					//---- [project_directory]filename.*
...
PERFORMANCE_FILE                        Results\Router_Hwy_LinkPerformance_SCEN                        //---- [project_directory]filename
...
TURN_DELAY_FILE                         Results\Router_Hwy_TurnDelay_SCEN                        //---- [project_directory]filename
...
NEW_PLAN_FILE                           Demand\Plans_SCEN_ProblemSet						//---- [project_directory]filename.*
...
NEW_PROBLEM_FILE                        Results\Router_Hwy_Problems_SCEN_ProblemSet.csv						//---- [project_directory]filename.*
...
NEW_PERFORMANCE_FILE                    Results\Router_Hwy_LinkPerformance_SCEN_ProblemSet
...
## TRIP_FILE                               Results\Router_Hwy_Problems_SCEN.csv    //---- [project_directory]filename.*
...
PLAN_FILE                               Demand\Plans_SCEN                        //---- [project_directory]filename.*
...
NEW_TURN_DELAY_FILE                     Results\Router_Hwy_TurnDelay_SCEN_ProblemSet
...
NEW_CAPACITY_CONSTRAINT_FILE			Outputs\Capacity_Constraints_SCEN_ProblemSet.txt
