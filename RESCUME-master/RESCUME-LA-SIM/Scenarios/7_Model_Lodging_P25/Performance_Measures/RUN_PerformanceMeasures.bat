:: PlanSum
REM CALL v6 bin64thread PlanSum.exe -k PlanSum_CreatePerfUsingPlans_BASE.ctl
REM CALL v6 bin64thread PlanSum.exe -k PlanSum_CreatePerfUsingPlans_SCEN.ctl
...
CALL v6 ArcPlan.exe -k ArcPlan_DrawPlans_SCEN.ctl
