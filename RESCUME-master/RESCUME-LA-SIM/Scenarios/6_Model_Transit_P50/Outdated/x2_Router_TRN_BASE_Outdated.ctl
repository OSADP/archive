...
TRANSIT_ROUTE_FORMAT                    COMMA_DELIMITED           //---- TEXT, BINARY, FIXED_COLUMN, COMMA_DELIMITED, SPACE_DELIMITED, TAB_DELIMITED, CSV_DELIMITED, DBASE, ARCVIEW, SQLITE3, VERSION3, TPPLUS, CUBE
...
TRANSIT_DRIVER_FORMAT                   COMMA_DELIMITED           //---- TEXT, BINARY, FIXED_COLUMN, COMMA_DELIMITED, SPACE_DELIMITED, TAB_DELIMITED, CSV_DELIMITED, DBASE, ARCVIEW, SQLITE3, VERSION3, TPPLUS, CUBE
...
## PERFORMANCE_FILE                        ..\4_Model_Router\Results\Conic_DUE10_RESKIM_OFF_FB_0_8\Router_Hwy_LinkPerformance_BASE.0                        //---- [project_directory]filename
...
## TURN_DELAY_FILE                         ..\4_Model_Router\Results\Conic_DUE10_RESKIM_OFF_FB_0_8\Router_Hwy_TurnDelay_BASE.0                        //---- [project_directory]filename
...
NEW_PLAN_FILE                           Demand\Plans_TRN_BASE                        //---- [project_directory]filename.*
NEW_PLAN_FORMAT                         TAB_DELIMITED           //---- TEXT, BINARY, FIXED_COLUMN, COMMA_DELIMITED, SPACE_DELIMITED, TAB_DELIMITED, CSV_DELIMITED, DBASE, ARCVIEW, SQLITE3, VERSION3, TPPLUS, CUBE
NEW_PROBLEM_FILE                        Results\Router_Problems_TRN_BASE.csv                        //---- [project_directory]filename.*
...
TRIP_FILE                               ..\..\Common_Inputs\3_Demand_v6\Trips_TRN_P15.csv                        //---- [project_directory]filename.*
## TRIP_FILE                               Demand\Router_Problems_TRN.csv                        //---- [project_directory]filename.*
...
SIGN_FILE                               ..\..\Common_Inputs\1_Network_v6\ASCIIFiles\Sign.csv                        //---- [project_directory]filename
...
SIGNAL_FILE                             ..\..\Common_Inputs\1_Network_v6\ASCIIFiles\Signal.csv                        //---- [project_directory]filename
...
DETECTOR_FILE							..\..\Common_Inputs\1_Network_v6\ASCIIFiles\Detector.csv
DETECTOR_FORMAT							COMMA_DELIMITED
TIMING_PLAN_FILE                        ..\..\Common_Inputs\1_Network_v6\ASCIIFiles\Timing_Plan.csv                        //---- [project_directory]filename
...
PHASING_PLAN_FILE                       ..\..\Common_Inputs\1_Network_v6\ASCIIFiles\Phasing_Plan.csv                        //---- [project_directory]filename
...
NEW_RIDERSHIP_FILE                      Results\Ridership_BASE.csv                        //---- [project_directory]filename
...
APPLICATION_METHOD                      DUE_PLANS                   //---- TRAVEL_PLANS, LINK_FLOWS, DUE_PLANS, DTA_FLOWS
