...
void ConnectsTo_Init (ConnectsTo_t* theObj);
//void ConnectsTo_ToBlob (ConnectsTo_t* theObj, char* theBlob);
//void ConnectsTo_FromBlob (ConnectsTo_t* theObj, char* theBlob);
