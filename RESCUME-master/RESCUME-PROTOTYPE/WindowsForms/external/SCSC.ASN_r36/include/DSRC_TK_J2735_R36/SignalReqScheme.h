...
void SignalReqScheme_Init (SignalReqScheme_t* theObj);
//void SignalReqScheme_ToBlob (SignalReqScheme_t* theObj, char* theBlob);
//void SignalReqScheme_FromBlob (SignalReqScheme_t* theObj, char* theBlob);
