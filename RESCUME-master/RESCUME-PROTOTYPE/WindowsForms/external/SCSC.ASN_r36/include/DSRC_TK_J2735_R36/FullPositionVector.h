...
void FullPositionVector_Init (FullPositionVector_t* theObj);
//void FullPositionVector_ToBlob (FullPositionVector_t* theObj, char* theBlob);
//void FullPositionVector_FromBlob (FullPositionVector_t* theObj, char* theBlob);
