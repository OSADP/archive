...
void RegionPointSet_Init (RegionPointSet_t* theObj);
//void RegionPointSet_ToBlob (RegionPointSet_t* theObj, char* theBlob);
//void RegionPointSet_FromBlob (RegionPointSet_t* theObj, char* theBlob);
