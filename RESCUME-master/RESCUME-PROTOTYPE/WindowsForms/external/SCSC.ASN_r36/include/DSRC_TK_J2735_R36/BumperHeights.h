...
void BumperHeights_Init (BumperHeights_t* theObj);
//void BumperHeights_ToBlob (BumperHeights_t* theObj, char* theBlob);
//void BumperHeights_FromBlob (BumperHeights_t* theObj, char* theBlob);
