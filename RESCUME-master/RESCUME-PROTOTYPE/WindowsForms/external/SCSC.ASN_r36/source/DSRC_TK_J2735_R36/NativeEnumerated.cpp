...
NativeEnumerated_decode_uper(asn_codec_ctx_t *opt_codec_ctx,
	...
	// DCK mod, add full cast as below
	if(ct->flags & APC_EXTENSIBLE) {
...
NativeEnumerated__compar_value2enum(const void *ap, const void *bp) {
	...
	// DCK mod, both lines replaced with full cast below
	const asn_INTEGER_enum_map_t *a = (asn_INTEGER_enum_map_t *)ap; // DCK cast
	const asn_INTEGER_enum_map_t *b = (asn_INTEGER_enum_map_t *)bp; // DCK cast
...
NativeEnumerated_encode_uper(asn_TYPE_descriptor_t *td,
	...
	kf = (asn_INTEGER_enum_map_t  *)bsearch(&key, specs->value2enum, specs->map_count,
		// DCK mod, replace above line to add full cast
	...
	//if(ct->flags & APC_EXTENSIBLE) {
	// DCK mod, above line replaced by below and full cast
	if(ct->flags & APC_EXTENSIBLE) {
