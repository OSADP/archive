...
static asn_TYPE_member_t asn_MBR_Member_3[] = {
	{ ATF_POINTER, 7, offsetof(struct TireMember, location),
	...
	{ ATF_POINTER, 6, offsetof(struct TireMember, pressure),
	...
	{ ATF_POINTER, 5, offsetof(struct TireMember, temp),
	...
	{ ATF_POINTER, 4, offsetof(struct TireMember, wheelSensorStatus),
	...
	{ ATF_POINTER, 3, offsetof(struct TireMember, wheelEndElectFault),
	...
	{ ATF_POINTER, 2, offsetof(struct TireMember, leakageRate),
	...
	{ ATF_POINTER, 1, offsetof(struct TireMember, detection),
...
static asn_SEQUENCE_specifics_t asn_SPC_Member_specs_3 = {
	sizeof(struct TireMember),
	offsetof(struct TireMember, _asn_ctx),
...
static asn_SET_OF_specifics_t asn_SPC_tires_specs_2 = {
	sizeof(struct tiresX),
	offsetof(struct tiresX, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_Member_13[] = {
	{ ATF_POINTER, 2, offsetof(struct AxleMember, location),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct AxleMember, weight),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_AxleWeight,
		0,	/* Defer constraints checking to the member type */
...
static asn_SEQUENCE_specifics_t asn_SPC_Member_specs_13 = {
	sizeof(struct AxleMember),
	offsetof(struct AxleMember, _asn_ctx),
...
static asn_SET_OF_specifics_t asn_SPC_axle_specs_12 = {
	sizeof(struct axleX),
	offsetof(struct axleX, _asn_ctx),
	0,	/* XER encoding is XMLDelimitedItemList */
};
static /* Use -fall-defs-global to expose */
