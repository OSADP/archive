...
static asn_TYPE_tag2member_t asn_MAP_item_tag2el_3[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* itis at 1933 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* text at 1934 */
};
...
static asn_TYPE_member_t asn_MBR_Member_2[] = {
	//{ ATF_NOFLAGS, 0, offsetof(struct Member, item_sl),
	// above offset does not resolve, so hard code as zero
	{ ATF_NOFLAGS, 0, 0,
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
...
static asn_TYPE_tag2member_t asn_MAP_Member_tag2el_2[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* item at 1933 */
};
static asn_SEQUENCE_specifics_t asn_SPC_Member_specs_2 = {
	sizeof(struct Member_sl),
	offsetof(struct Member_sl, _asn_ctx),
