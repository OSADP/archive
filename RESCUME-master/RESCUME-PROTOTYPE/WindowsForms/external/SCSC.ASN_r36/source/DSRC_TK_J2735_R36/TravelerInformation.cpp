...
static asn_TYPE_member_t asn_MBR_msgId_9[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct tiMsgId, choice.furtherInfoID),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct tiMsgId, choice.roadSignID),
...
static asn_TYPE_tag2member_t asn_MAP_msgId_tag2el_9[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* furtherInfoID at 458 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* roadSignID at 462 */
};
static asn_CHOICE_specifics_t asn_SPC_msgId_specs_9 = {
	sizeof(struct tiMsgId),
	offsetof(struct tiMsgId, _asn_ctx),
	offsetof(struct tiMsgId, present),
	sizeof(((struct tiMsgId *)0)->present),
...
static asn_SET_OF_specifics_t asn_SPC_regions_specs_19 = {
	sizeof(struct tiRegions),
	offsetof(struct tiRegions, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_content_21[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct tiContent, choice.advisory),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct tiContent, choice.workZone),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_WorkZone,
		0,	/* Defer constraints checking to the member type */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct tiContent, choice.genericSign),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct tiContent, choice.speedLimit),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct tiContent, choice.exitService),
...
static asn_TYPE_tag2member_t asn_MAP_content_tag2el_21[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* advisory at 480 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* workZone at 482 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* genericSign at 484 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* speedLimit at 486 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 } /* exitService at 491 */
};
static asn_CHOICE_specifics_t asn_SPC_content_specs_21 = {
	sizeof(struct tiContent),
	offsetof(struct tiContent, _asn_ctx),
	offsetof(struct tiContent, present),
	sizeof(((struct tiContent *)0)->present),
...
static asn_TYPE_member_t asn_MBR_Member_7[] = {
	// DCK mod, in all below change "Member" to be "tiMember"
	{ ATF_NOFLAGS, 0, offsetof(struct tiMember, frameType),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct tiMember, msgId),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	...
	{ ATF_POINTER, 1, offsetof(struct tiMember, startYear),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_DYear,
		0,	/* Defer constraints checking to the member type */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct tiMember, startTime),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct tiMember, duratonTime),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct tiMember, priority),
	...
	{ ATF_POINTER, 3, offsetof(struct tiMember, commonAnchor),
	...
	{ ATF_POINTER, 2, offsetof(struct tiMember, commonLaneWidth),
	...
	{ ATF_POINTER, 1, offsetof(struct tiMember, commonDirectionality),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct tiMember, regions),
		(ASN_TAG_CLASS_CONTEXT | (9 << 2)),
		0,
		&asn_DEF_regions_19,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct tiMember, content),
	...
	{ ATF_POINTER, 1, offsetof(struct tiMember, url),
...
static asn_TYPE_tag2member_t asn_MAP_Member_tag2el_7[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* frameType at 456 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* msgId at 458 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* startYear at 463 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* startTime at 465 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* duratonTime at 466 */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 }, /* priority at 467 */
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0, 0 }, /* commonAnchor at 470 */
    { (ASN_TAG_CLASS_CONTEXT | (7 << 2)), 7, 0, 0 }, /* commonLaneWidth at 472 */
    { (ASN_TAG_CLASS_CONTEXT | (8 << 2)), 8, 0, 0 }, /* commonDirectionality at 474 */
    { (ASN_TAG_CLASS_CONTEXT | (9 << 2)), 9, 0, 0 }, /* regions at 476 */
    { (ASN_TAG_CLASS_CONTEXT | (10 << 2)), 10, 0, 0 }, /* content at 480 */
    { (ASN_TAG_CLASS_CONTEXT | (11 << 2)), 11, 0, 0 } /* url at 492 */
};
static asn_SEQUENCE_specifics_t asn_SPC_Member_specs_7 = {
	sizeof(struct tiMember),
	offsetof(struct tiMember, _asn_ctx),
...
static asn_SET_OF_specifics_t asn_SPC_dataFrames_specs_6 = {
	sizeof(struct dataFrames_ti),
	offsetof(struct dataFrames_ti, _asn_ctx),
	0,	/* XER encoding is XMLDelimitedItemList */
};
static /* Use -fall-defs-global to expose */
...
static asn_TYPE_tag2member_t asn_MAP_TravelerInformation_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* packetID at 449 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* urlB at 450 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* dataFrameCount at 451 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* dataFrames at 493 */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 } /* crc at 494 */
};
...
void TravelerInformation_Init ( TravelerInformation_t* theObj)
{
	if (theObj != NULL)
	{
		theObj->msgID = DSRCmsgID_travelerInformation; 
		theObj->packetID = NULL;
		theObj->urlB = NULL;
		theObj->dataFrameCount = NULL;
		// user must still deal with the correct numebr of 
		// data fram counts once  known
		// theObj->dataFrames --->>>
