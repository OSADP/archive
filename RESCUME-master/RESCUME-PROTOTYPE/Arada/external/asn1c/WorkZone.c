...
static asn_TYPE_member_t asn_MBR_item_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct item_wz, choice.itis),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct item_wz, choice.text),
...
static asn_CHOICE_specifics_t asn_SPC_item_specs_3 = {
	sizeof(struct item_wz),
	offsetof(struct item_wz, _asn_ctx),
	offsetof(struct item_wz, present),
	sizeof(((struct item_wz *)0)->present),
