...
import org.battelle.inczone.inczoneui.obu.handlers.NmeaMessageHandler;
import org.battelle.inczone.inczoneui.obu.handlers.VehicleMessageHandler;
...
public class ObuBluetoothService extends Service implements JsonMessageHandler {
	...
	private final static String PREFIX = "org.battelle.inczone.inczoneui.obu.ObuBluetoothService";
	...
	public void onCreate() {
		...
		rReceiveHandlers.add(new NmeaMessageHandler(this, this));
		rReceiveHandlers.add(new AlertMessageHandler(this, this));
