...
namespace VescoConsole
{
    class Vesco
    {
        ...
        public Vesco(Boolean _isReOptimized, List<VescoOrder> _vescoOrders, List<String> _badOrders, String _importFileName, String _carrier)
        {
            ...
            Dictionary<string, string> Properties = Util.GetProperties(AppDomain.CurrentDomain.BaseDirectory + "\\settings.properties");
        ...
        private void performStepOne()
        {
            ...
            try
            {
                ...
                workbook = excelObj.Workbooks.Open(AppDomain.CurrentDomain.BaseDirectory + "\\Templates\\Vesco.xlsx");
            }
            catch (Exception ex)
            {
                ex.ToString();
...
//                label6.Text = (routeStopRowCount - 1).ToString();
        ...
        void importLocations()
        {
            ...
            try
            {
                ...
                locationBook = locationApp.Workbooks.Open(AppDomain.CurrentDomain.BaseDirectory + "\\Templates\\Vesco.xlsx");
...
//                        label10.Text = locations.Count.ToString();
            ...
            {
                VescoLog.eventLog1.WriteEntry(ex.StackTrace);
            }
            finally
            {
                if (locationRange != null)
        ...
        void importDrivers()
        {
            ...
            try
            {
                ...
                driverBook = driverApp.Workbooks.Open(AppDomain.CurrentDomain.BaseDirectory + "\\Templates\\Vesco.xlsx");
                ...
                */
                ...
                for (int i = 2; i <= driverRowCount; i++) // Start at the second row and skip the header
                {
                    ...
                    if (driver.StartingLocation == null)
                    {
                        ...
                        VescoLog.eventLog1.WriteEntry("Warning, " + tempLocName + " is not a valid Starting Locaiton for driver " + driver.DisplayName);
                    }
                    else
                    {
                        drivers.Add(driver);
...
//            label16.Text = badDrivers.Count.ToString();
        ...
        void importRouteStops()
        {
            ...
            try
            {
                ...
                routeStopBook = routeStopApp.Workbooks.Open(AppDomain.CurrentDomain.BaseDirectory + "\\Templates\\Vesco.xlsx");
...
//                                label9.Text = jobs.Count.ToString();
                ...
                {
                    VescoLog.eventLog1.WriteEntry(ex.Message);
                    VescoLog.eventLog1.WriteEntry(ex.StackTrace);
        ...
        private void performStepThree()
        {
            ...
            if (jobs.Count > 0)
            {
                ...
                generatedLocalFile = AppDomain.CurrentDomain.BaseDirectory + "\\Templates\\Plans\\" + generatedLocalFileName;
                ...
                using (StreamWriter outfile = new StreamWriter(generatedLocalFile))
                {
                    ...
                    using (StreamWriter ftpFile = new StreamWriter(
                        AppDomain.CurrentDomain.BaseDirectory + "\\Templates\\Ftp\\" + ftpFileName))
                    {
            ...
            {
                Console.WriteLine("There are no route stops to optimize.");
            }
        ...
        public void ftpFileToLeidos()
        {
            ...
            String localFilePath = AppDomain.CurrentDomain.BaseDirectory + "Templates\\Ftp\\";
            ...
            try
            {
                ...
                VescoLog.eventLog1.WriteEntry(ftpFileName + ", FTP File to Leidos success.");
            }
            catch (WebException we)
            {
                VescoLog.eventLog1.WriteEntry("Cannot connect to the FTP Leidos server.  Please, make sure you are connected to the internet and try again.  " + we.Message);
            }
        }
        ...
        public void ftpPlanToLeidos()
        {
            ...
            try
            {
                ...
                FtpWebResponse response = (FtpWebResponse)request.GetResponse();
                VescoLog.eventLog1.WriteEntry(generatedLocalFile + ", FTP Plan to Leidos success.");
        ...
        public void ftpFileToTrinium()
        {
            ...
            try
            {
                ...
                FtpWebResponse response = (FtpWebResponse)request.GetResponse();
                VescoLog.eventLog1.WriteEntry(ftpFileName + ", FTP File to Trinium success.");
            }
            catch (WebException we)
            {
                VescoLog.eventLog1.WriteEntry("Cannot connect to the FTP Leidos server.  Please, make sure you are connected to the internet and try again.  " + we.Message);
