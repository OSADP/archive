...
static asn_TYPE_member_t asn_MBR_item_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct item_it, choice.itis),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct item_it, choice.text),
...
static asn_CHOICE_specifics_t asn_SPC_item_specs_3 = {
	sizeof(struct item_it),
	offsetof(struct item_it, _asn_ctx),
	offsetof(struct item_it, present),
	sizeof(((struct item_it *)0)->present),
