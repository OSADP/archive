...
void BarrierLane_Init (BarrierLane_t* theObj);
//void BarrierLane_ToBlob (BarrierLane_t* theObj, char* theBlob);
//void BarrierLane_FromBlob (BarrierLane_t* theObj, char* theBlob);
