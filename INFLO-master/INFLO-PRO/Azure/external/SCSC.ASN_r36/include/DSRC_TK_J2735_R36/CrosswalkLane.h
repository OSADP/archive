...
void CrosswalkLane_Init (CrosswalkLane_t* theObj);
//void CrosswalkLane_ToBlob (CrosswalkLane_t* theObj, char* theBlob);
//void CrosswalkLane_FromBlob (CrosswalkLane_t* theObj, char* theBlob);
