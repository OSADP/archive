...
void Position3D_Init (Position3D_t* theObj);
//void Position3D_ToBlob (Position3D_t* theObj, char* theBlob);
//void Position3D_FromBlob (Position3D_t* theObj, char* theBlob);
