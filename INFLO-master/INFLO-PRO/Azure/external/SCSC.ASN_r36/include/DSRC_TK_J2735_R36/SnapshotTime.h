...
void SnapshotTime_Init (SnapshotTime_t* theObj);
//void SnapshotTime_ToBlob (SnapshotTime_t* theObj, char* theBlob);
//void SnapshotTime_FromBlob (SnapshotTime_t* theObj, char* theBlob);
