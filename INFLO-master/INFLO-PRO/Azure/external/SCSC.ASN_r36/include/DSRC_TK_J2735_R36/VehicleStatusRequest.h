...
void VehicleStatusRequest_Init (VehicleStatusRequest_t* theObj);
//void VehicleStatusRequest_ToBlob (VehicleStatusRequest_t* theObj, char* theBlob);
//void VehicleStatusRequest_FromBlob (VehicleStatusRequest_t* theObj, char* theBlob);
