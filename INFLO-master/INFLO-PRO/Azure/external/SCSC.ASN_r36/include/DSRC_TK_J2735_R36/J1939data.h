 ...
 * 	found in "DSRC_R29_Source.ASN.txt"
 * 	`asn1c -S/skeletons`
 */
...
//
// DCK added structures to make visable to others
//

typedef struct TireMember {
...
typedef	struct tiresX {
		A_SEQUENCE_OF(struct TireMember ) list;
...
typedef	struct axleX {
		A_SEQUENCE_OF(struct AxleMember ) list;
...
// 
// DCK edits end (plus below inserts)
///
...
void J1939data_Init (J1939data_t* theObj);
//void J1939data_ToBlob (J1939data_t* theObj, char* theBlob);
//void J1939data_FromBlob (J1939data_t* theObj, char* theBlob);
