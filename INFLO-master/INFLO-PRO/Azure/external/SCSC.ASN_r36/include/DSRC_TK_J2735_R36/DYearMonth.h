...
void DYearMonth_Init (DYearMonth_t* theObj);
//void DYearMonth_ToBlob (DYearMonth_t* theObj, char* theBlob);
//void DYearMonth_FromBlob (DYearMonth_t* theObj, char* theBlob);
