...
void SignalRequest_Init (SignalRequest_t* theObj);
//void SignalRequest_ToBlob (SignalRequest_t* theObj, char* theBlob);
//void SignalRequest_FromBlob (SignalRequest_t* theObj, char* theBlob);
