...
void TemporaryID_Init ( TemporaryID_t* theObj)
{
	if (theObj != NULL)
	{
		// Allocate memory needed on heap
		int bufSize = TemporaryID_BuffSize;
...
void TemporaryID_ToBlob ( TemporaryID_t* theObj, char* theBlob)
{
...
void TemporaryID_FromBlob ( TemporaryID_t* theObj, char* theBlob)
{
	if ((theObj != NULL) && (theBlob != NULL))
	{
	}
