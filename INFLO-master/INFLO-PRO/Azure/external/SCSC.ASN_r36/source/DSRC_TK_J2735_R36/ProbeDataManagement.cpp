...
static asn_TYPE_member_t asn_MBR_term_5[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct Term_pd, choice.termtime),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Term_pd, choice.termDistance),
...
static asn_TYPE_tag2member_t asn_MAP_term_tag2el_5[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* termtime at 247 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* termDistance at 251 */
};
static asn_CHOICE_specifics_t asn_SPC_term_specs_5 = {
	sizeof(struct Term_pd),
	offsetof(struct Term_pd, _asn_ctx),
	offsetof(struct Term_pd, present),
	sizeof(((struct Term_pd *)0)->present),
...
static asn_TYPE_member_t asn_MBR_snapshot_8[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct Snapshot_pd, choice.snapshotTime),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Snapshot_pd, choice.snapshotDistance),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_TYPE_tag2member_t asn_MAP_snapshot_tag2el_8[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* snapshotTime at 253 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* snapshotDistance at 255 */
};
static asn_CHOICE_specifics_t asn_SPC_snapshot_specs_8 = {
	sizeof(struct Snapshot_pd),
	offsetof(struct Snapshot_pd, _asn_ctx),
	offsetof(struct Snapshot_pd, present),
	sizeof(((struct Snapshot_pd *)0)->present),
...
static asn_SET_OF_specifics_t asn_SPC_dataElements_specs_13 = {
	sizeof(struct DataElements_pd),
	offsetof(struct DataElements_pd, _asn_ctx),
...
static asn_TYPE_tag2member_t asn_MAP_ProbeDataManagement_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* msgID at 239 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* sample at 242 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* directions at 244 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* term at 247 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* snapshot at 253 */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 }, /* txInterval at 256 */
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0, 0 }, /* cntTthreshold at 257 */
    { (ASN_TAG_CLASS_CONTEXT | (7 << 2)), 7, 0, 0 } /* dataElements at 259 */
};
