...
void MsgCRC_Init (MsgCRC_t* theObj)
{
	if (theObj != NULL)
	{
		// allocate memory needed on heap
		int bufSize = MsgCRC_BuffSize;
...
void MsgCRC_ToBlob (MsgCRC_t* theObj, char* theBlob)
{
...
void MsgCRC_FromBlob (MsgCRC_t* theObj, char* theBlob)
{
	if ((theObj != NULL) && (theBlob != NULL))
	{
	}
