...
static asn_TYPE_member_t asn_MBR_area_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct area_vr, choice.shapePointSet),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct area_vr, choice.circle),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct area_vr, choice.regionPointSet),
...
static asn_TYPE_tag2member_t asn_MAP_area_tag2el_4[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* shapePointSet at 1959 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* circle at 1961 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* regionPointSet at 1965 */
};
static asn_CHOICE_specifics_t asn_SPC_area_specs_4 = {
	sizeof(struct area_vr),
	offsetof(struct area_vr, _asn_ctx),
	offsetof(struct area_vr, present),
	sizeof(((struct area_vr *)0)->present),
...
static asn_TYPE_tag2member_t asn_MAP_ValidRegion_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* direction at 1952 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* extent at 1954 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* area at 1959 */
};
